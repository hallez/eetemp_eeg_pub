...
for isub = 1:length(subjects)
    ...
    set_str_in = 'downsamp_electrode-ids_revalued-events_reref';
    set_str_out = sprintf('hpf-ica-%0.2g', config.hpf_ica_cutoff);
    ...
    for iset = 1:config.num_blocks
        ...
        EEG  = pop_basicfilter( EEG,  1:70 , 'Boundary', 'boundary', 'Cutoff',  config.hpf_ica_cutoff,...

...
% In this particular script we correlate the ERPs from REM trials with FAM
% hits corrected behavioral results.
...
% Here are the values of FAM hits corrected results from behavioral analysis.
